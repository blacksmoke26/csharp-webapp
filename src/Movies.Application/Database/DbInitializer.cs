  ...
  public async Task InitializeAsync() {
    ...
    await connection.ExecuteAsync(
      ...
      CREATE TABLE IF NOT EXISTS "public"."users" (
        ...
        CONSTRAINT "UNQ_users_auth_key" UNIQUE ("auth_key")
      );
      ...
      COMMENT ON COLUMN "public"."users"."password_reset_token" IS 'Password Reset Token';
    ...
    await connection.ExecuteAsync(
      ...
      CREATE TABLE IF NOT EXISTS "public"."movies" (
        ...
        CONSTRAINT "FK_movies_user_id_users_id" FOREIGN KEY ("user_id") 
      ...
      COMMENT ON COLUMN "public"."movies"."status" IS 'Status';

      COMMENT ON COLUMN "public"."movies"."created_at" IS 'Created';

      COMMENT ON COLUMN "public"."movies"."updated_at" IS 'Updated';

      COMMENT ON CONSTRAINT "UNQ_Title_YoR" 
              ON "public"."movies" IS 'Title and Year must be unique';

      COMMENT ON CONSTRAINT "UNQ_slug" 
              ON "public"."movies" IS 'Slug is always unique (alternative to ID)';
    ...
    await connection.ExecuteAsync(
      ...
      CREATE TABLE IF NOT EXISTS "public"."genres" (
        ...
        CONSTRAINT "FK_genres_movie_id_movies_id" FOREIGN KEY ("movie_id") 
      ...
      COMMENT ON CONSTRAINT "FK_genres_movie_id_movies_id" 
              ON "public"."genres" IS 'Reference to Movie ID';

      COMMENT ON CONSTRAINT "UNQ_movie_name_genre" 
              ON "public"."genres" IS 'Movie ID and Genre name must be unique';
      """);
    ...
    await connection.ExecuteAsync(
      ...
      CREATE TABLE IF NOT EXISTS "public"."ratings" (
        ...
        "user_id" int8 NOT NULL,
        "movie_id" int8 NOT NULL,
        "score" int2 NOT NULL DEFAULT 1,
        "feedback" text,
        "created_at" timestamp,
        "updated_at" timestamp,
        PRIMARY KEY ("id"),
        CONSTRAINT "FK_ratings_movie_id_movies_id" FOREIGN KEY ("movie_id") 
          REFERENCES "public"."movies" ("id") ON DELETE CASCADE ON UPDATE CASCADE,
        CONSTRAINT "FK_ratings_user_id_users_id" FOREIGN KEY ("user_id") 
          REFERENCES "public"."users" ("id") ON DELETE CASCADE ON UPDATE CASCADE,
      ...
      COMMENT ON COLUMN "public"."ratings"."score" IS 'Score';
      ...
      COMMENT ON CONSTRAINT "IDX_ratings_user_id_movie_id" 
              ON "public"."ratings" IS 'Movie and User should be unique';
      """);
  }
}